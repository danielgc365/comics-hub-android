...
import org.yarnapps.comicshub.AppRater;
...
import org.yarnapps.comicshub.dialogs.FilterSortDialog;
import org.yarnapps.comicshub.dialogs.RecommendationsPrefDialog;
...
import org.yarnapps.comicshub.services.ImportService;
import org.yarnapps.comicshub.utils.ChangesObserver;
import org.yarnapps.comicshub.utils.DrawerHeaderImageTool;
...
import org.yarnapps.comicshub.utils.StorageUpgradeTask;
import org.yarnapps.comicshub.utils.choicecontrol.ModalChoiceCallback;
import org.yarnapps.comicshub.utils.choicecontrol.ModalChoiceController;

import java.io.File;

//todo make first screen the comic list V2
//todo make imports for .cbr files V2
//todo make cards for gridview V2
//todo remove save image from reader activity
...
public class MainActivity extends BaseAppActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String appKey = "df885fb2841727f267638665e32792590e6c9dc61dc0e546";
        ...
        mNavigationView.setNavigationItemSelectedListener(this);
        Menu innerMenu = mNavigationView.getMenu();
        //innerMenu.findItem(R.id.nav_action_upgrade).setVisible(!mPaid);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        //TODO if(paid) use
        //menu.findItem(R.id.nav_action_upgrade).setVisible(false);
        //TODO to remove the upgrade option (comment it after testing it once)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            /*case R.id.nav_action_upgrade:
                ...
                startActivity(upgradeIntent);todo
                break;*/
            default:
                mProvider = mProviderManager.getProvider(item.getItemId());
                break;
        }
       /* if(item.getItemId() == R.id.nav_action_upgrade){
